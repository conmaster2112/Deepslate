...
namespace ConMaster.Buffers.String
{
    ...
    {
        private const uint P0 = 2309635468;
        private const uint P1 = 4165490531;
        /// <summary>
        /// Compute a Marvin hash and collapse it into a 32-bit hash.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveOptimization)]
        public static int ComputeHash32(ReadOnlySpan<byte> bytes)
        {
            ref byte data = ref MemoryMarshal.GetReference(bytes);
            uint count = (uint)bytes.Length, p0 = P0, p1 = P1;
