...
using ConMaster.Bedrock.Types.DataItems;
using ConMaster.Bedrock.Level;

namespace ConMaster.Bedrock.Data
{
    public class Entity
    {
        ...
        private readonly Dictionary<int, EntityComponent> _Components = [];
        ...
        public Entity(EntityType type) {
            ...
            Velocity = Location = Vec3.Zero;
            Type = type;
            Dimension = null!;
            type.CreateEntityComponents(this, _Components);
            HasGravity = true;
            SetAllUpdateBits(0);
        }
        public EntityRotation Rotation { get; protected set; }
        ...
        public ChunkPosition ChunkPosition => new((int)MathF.Floor(Location.X) >> 4, (int)MathF.Floor(Location.Z) >> 4);
