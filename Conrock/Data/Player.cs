...
namespace ConMaster.Bedrock.Data
{
    public class Player: Entity
    {
        ...
        public PlayerChunkManager ChunkManager;
        ...
        internal Player(Client client): base(PlayerEntityType.Instance)
        {
        ...
        public void Disconnect(string reason) => Client.Disconnect(reason, DisconnectReason.Kicked);
        public void SendToast(string title, string content)
        {
            ToastRequestPacket packet = ToastRequestPacket.Create();
            packet.Title = title;
        ...
        internal virtual void OnPlayerMoved(MovePlayerPacket packet)
        {
            ...
            if(IsSpawned) ChunkManager.OnPlayerMove(ChunkPosition);
        }
    }
}
